...
int main() {
    ...
    std::ifstream arquivo("/home/palomajo/Área de Trabalho/Códigos/Dados/properties");
...
void selectEos(int opcao, double Tc, double Pc, double omega, double T, double V_min, double V_max, int num_points) {
    ...
    std::string filename = "pressao_T" + std::to_string(static_cast<int>(T)) + ".txt"; //quero colocar esse arquivo dentro de Dados calculados
